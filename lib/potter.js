...
(function() {
  var Handlebars, P, S, TriggerFlow, configs, dt, fs, hl, inPotterPath, less, marked, newArticle, newSite, next, path, publish, rock, util, _;
  ...
  newSite = function(path, callback) {
    return rock.create(path, '/Users/jprichardson/Dropbox/Projects/Personal/rocks/rock-potter', callback);
  };

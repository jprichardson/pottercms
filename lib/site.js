...
(function() {
  var DEFAULT_ROCK, Handlebars, P, S, Site, batchfile, bd, dt, fs, hl, loadFilesInDir, marked, next, packageObj, parent, path, potter, potterPackage, rock, util, _,
      ...
      return next(flow = {
        ...
        iterateArticles: function() {
          ...
          b = batchfile(articleFiles).transform(function(i, file, data, write) {
            var articleData, html, htmlFile, md, slug, urlData;
